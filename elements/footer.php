...
<div id="shopify-section-sections--14655940165750__footer" class="shopify-section shopify-section-group-group-footer">
    <!-- /sections/footer.liquid -->


    <footer class="footer" data-section-id="sections--14655940165750__footer" data-section-type="footer"
                            ...
                            <div class="grid grid--uniform" data-accordion-group="">
                                <div class="grid__item medium-up--one-third footer__block">
                                    <p class="footer__title footer__accordion__head js "
                                        data-accordion-trigger="accordion-text-3-1" aria-controls="accordion-text-3-1"
                                    ...
                                    <input type="checkbox" name="accordion-text-3-1" id="accordion-text-3-1-checkbox"
                                ...
                                <div class="grid__item medium-up--one-third footer__block">
                                    <p class="footer__title footer__accordion__head js "
                                        ...
                                        aria-controls="accordion-linklist-1-2" role="button" aria-haspopup="true"
                                        aria-label="Footer Menu" aria-expanded="false">
                                        HELPFUL LINKS
                                        <svg aria-hidden="true" focusable="false" role="presentation"
                                            class="icon icon-arrow-medium-right" viewBox="0 0 9 15">
                                            <path fill-rule="evenodd"
                                    ...
                                    <input type="checkbox" name="accordion-linklist-1-2"
                                        id="accordion-linklist-1-2-checkbox" class="no-js no-js-checkbox">
                                ...
                                <div class="grid__item medium-up--one-third footer__block">
                                    <p class="footer__title footer__accordion__head js "
                                        ...
                                        aria-controls="accordion-54b51580-46c4-422b-8700-967b58f8a8da-3" role="button"
                                        aria-haspopup="true" aria-label="Main Menu" aria-expanded="false">
                                        Menu
                                        <svg aria-hidden="true" focusable="false" role="presentation"
                                            class="icon icon-arrow-medium-right" viewBox="0 0 9 15">
                                            <path fill-rule="evenodd"
                                    ...
                                    <input type="checkbox" name="accordion-54b51580-46c4-422b-8700-967b58f8a8da-3"
                                    ...
                                    <ul class="footer__quicklinks footer__accordion__body no-js-accordion"
                                        ...
                                        <li><a href="<?php echo BASE_URL; ?>customized-gifts">CUSTOMISED ITEMS</a></li>
...
<div id="shopify-section-sections--14655940165750__subfooter"
    class="shopify-section shopify-section-group-group-footer">
    <!-- /sections/subfooter.liquid -->
    <section class="subfooter" data-section-id="sections--14655940165750__subfooter" data-section-type="footer"
        style="--PT: 36px; --PB: 36px;">
                ...
                <div class="subfooter__item subfooter__item--social">
                    <a class="footer__icon footer__icon--social" href="/"
                        ...
                        <svg aria-hidden="true" focusable="false" role="presentation" class="icon icon-tiktok"
                            viewBox="0 0 19 19">
                            <path
                                d="M12.917 1c.289 2.412 1.674 3.85 4.083 4.004v2.713c-1.396.133-2.619-.311-4.04-1.148v5.075c0 6.447-7.232 8.461-10.14 3.84-1.867-2.973-.723-8.19 5.27-8.4v2.862a8.879 8.879 0 0 0-1.391.331c-1.333.439-2.089 1.26-1.879 2.708.404 2.775 5.641 3.596 5.206-1.825V1.005h2.891V1Z"
                        ...
                        <div class="wrapper">
                            <div class="search__predictive__main">
                                <div class="search__predictive__actions">
                                    ...
                                    <input type="search" data-predictive-search-input="search-popdown-results" name="q"
                                        value="" placeholder="Search..." aria-label="Search our store"
                                    ...
                                    <div class="search__predictive__clear">
                                        <button type="reset"
                                            ...
                                            aria-label="Reset">
                                            <svg aria-hidden="true" focusable="false" role="presentation"
                                                class="icon icon-close" viewBox="0 0 15 15">
                                                <g fill-rule="evenodd">
                                ...
                                <div class="search__predictive__close">
                                    <button type="button" class="search__predictive__close__inner" data-close-popdown=""
                                        aria-label="Close">
                                        <svg aria-hidden="true" focusable="false" role="presentation"
                                            class="icon icon-close-small" viewBox="0 0 15 15">
                                            <g fill-rule="evenodd">
                                                <path d="m2.237 1.073 12.021 12.021-1.414 1.414L.824 2.488z"></path>
                                                <path d="m.823 13.094 12.021-12.02 1.414 1.413-12.02 12.021z">
                                                </path>
                                            </g>
                                        </svg>
                                    </button>
...
<!-- <div id="shopify-block-Aajk0TllTV2lJZTdoT__15683396631634586217" class="shopify-block shopify-app-block">
    ...
    <script
        src="https://cdn.shopify.com/extensions/c6defb98-55a3-4757-8c1c-9616760c9bd7/inbox-1247/assets/shopifyChatV1Widget.js"
        type="module" defer="" async="" data-button-color="#5894b3" data-secondary-color="#ffffff"
        data-ternary-color="#6a6a6a" data-icon="chat_bubble" data-text="no_text" data-position="bottom_left"
        data-vertical-position="higher" data-shop-id="tL_nks2zcYr2OkopjymhAGL49EjPIEo4GYKO2d2XgHw"
...
</style><iframe scrolling="no" frameborder="0" allowtransparency="true"
    src="https://platform.twitter.com/widgets/widget_iframe.2f70fb173b9000da126c79afe2098f02.html?origin=https%3A%2F%2Fboxfox.com"
    title="Twitter settings iframe" style="display: none;"></iframe>
<div id="swell-overlay"></div><iframe id="swell-popup" class="yui3-cssreset" onload="spapi.loadFiles()"
    title="loyalty popup">
    <div style='width:100%;height:100%;background-color:white;text-align:center;'></div>
</iframe>
<div class="swell-tab"
